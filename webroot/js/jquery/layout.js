 ...
 */
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
			applyDefaultStyles: 	true		// apply basic styles directly to resizers & buttons? If not, then stylesheet must handle it
		...
		,	togglerLength_open:		140			// Length = WIDTH of toggler button on north/south edges - HEIGHT on east/west edges
		,	togglerLength_closed: 	140			// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
